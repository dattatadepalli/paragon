...
```jsx live
<>
  <Form.Radio className="ms-2" name="color" value="red">Red</Form.Radio>
  <Form.Radio className="ms-2" name="color" value="green" defaultChecked>Green</Form.Radio>
  <Form.Radio className="ms-2" name="color" value="blue">Blue</Form.Radio>
  <Form.Radio className="ms-2" name="color" value="cyan" disabled>Cyan</Form.Radio>
</>
```
